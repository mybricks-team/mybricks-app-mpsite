...
const Application = () => {
  const handler = useCallback((data) => {
    ...
    // 判断构建平台
    if ([CompileType.alipay, CompileType.dd, CompileType.h5, CompileType.miniprogram, CompileType.weapp, CompileType.harmony, CompileType.taro].includes(data.fileContent?.type)) {
