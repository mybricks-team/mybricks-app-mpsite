  ...
  if (useTabBar) {
    return tabBar.map((item) => {
      return {
        ...
        type: item.type,
        text: item.text,
        selectedIconUseImg: item.selectedIconUseImg,
        selectedIcon: item.selectedIcon,
        selectedFontIconStyle: item.selectedFontIconStyle,
        ...
        normalIconUseImg: item.normalIconUseImg,
        normalIcon: item.normalIcon,
        normalFontIconStyle: item.normalFontIconStyle,
