...
import RootPortal from './taro-docs/promoteRootPortal.md';
import ScrollView from './taro-docs/promoteScrollView.md';
import Swiper from './taro-docs/promoteSwiper.md';
import SwiperItem from './taro-docs/promoteSwiperItem.md';
import Text from './taro-docs/promoteText.md';
import View from './taro-docs/promoteView.md';
import Radio from './taro-docs/Radio.md';
